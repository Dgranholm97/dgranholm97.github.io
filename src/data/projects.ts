...
export const projects = [
  {
    ...
    sketch: {
      src: '/images/robot-sketch.png',
      alt: 'Hand-drawn engineering sketch of a differential-drive mobile robot',
      label: 'mobile base sketch',
      position: 'center',
    },
  ...
  },
  {
    ...
    sketch: {
      ...
      alt: 'Hand-drawn engineering sketch of an autonomous aerial inspection robot',
  ...
  },
  {
    ...
    sketch: {
      ...
      alt: 'Hand-drawn engineering sketch of a robotic arm manipulator',
      label: 'manipulation sketch',
      position: 'center',
    },
